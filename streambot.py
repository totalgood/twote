# *** Just a copy! the bot being run by supervisor is one level up on TG with same name***
# once we merge the hackortwote branch into master refs to hackor need to change
...
from twote.settings import BASE_DIR
